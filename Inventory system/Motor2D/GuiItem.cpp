...
{
	//TODO 7: iterate all the slots that the item occupies and free them (inventory_item = NULL)
...
void GuiItem::Move()
{ 
	//TODO 5: Fill Move() function so, the item movement is exactly like the cursor (hint: not using the draggable property or mouse motion)
